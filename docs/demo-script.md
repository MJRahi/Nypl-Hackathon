# Walkthrough — 3-minute demo script
...
> hallway five minutes before a viewing. Walkthrough does that lookup for
...
> story. That's Walkthrough: one address in, the public record out, in the
